...
func TestIntersect(t *testing.T) {
	...
	list2 = append(list2, Posting{4, []int64{8, 213, 9}})
	list2 = append(list2, Posting{8, []int64{25, 39, 89}})
	...
	if !arrayEqual {
		t.Errorf("Wrong Positions in first posting, expected {1,2,5,6,7,8}")
	}
